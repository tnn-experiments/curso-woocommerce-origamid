        ...
        <div class="filtro">
            ...
            <form class="filtro-preco">
                <div>
                    ...
                    <input required type="text" name="min_price" id="min_price" value="<?= isset( $_GET['min_price'] ) ? $_GET['min_price'] : ''; ?>">
                    
                </div>

                <div>
                    <label for="max_price">Até R$</label>
                    <input required type="text" name="max_price" id="max_price" value="<?= isset( $_GET['max_price'] ) ? $_GET['max_price'] : ''; ?>">
                </div> 
